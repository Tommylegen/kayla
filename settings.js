...
global.hituet = 0
global.gopayno = "-"
global.danano = "0895-0505-4287"
global.shopeepayno = "-"
global.creator = "6289505054287@s.whatsapp.net"
global.thumb = fs.readFileSync(`./image/thumb.png`)
global.qrisdonate = fs.readFileSync(`./image/qris.jpg`)
global.fake = `📍𝑪𝒓𝒆𝒂𝒕𝒆𝒅 𝑩𝒚 𝑹𝒂𝒋𝒂𝒅𝒆𝒗 𝑩𝒐𝒕 𝑾𝒉𝒂𝒕𝒔𝑨𝒑𝒑`
global.packname = ``
global.author = `×͜× ▭▬▭▬▭▬ 👑 ▭▬▭▬▭▬ ×͜×\nﾒ 𝗖𝗿𝗲𝗮𝘁𝗲𝗱 𝗕𝘆 𝗥𝗮𝗷𝗮𝗱𝗲𝘃\nﾒ 𝗖𝗿𝗲𝗮𝘁𝗼𝗿 𝗥𝗮𝗷𝗮 : *089505054287*\nﾒ 𝗬𝗼𝘂𝘁𝘂𝗯𝗲 : 𝗥𝗔𝗝𝗔 𝗠𝗼𝗱𝘀\n⊟————————⊟`
global.antilink = false
global.antiwame = false
global.autodltt = true
global.autosticker = false
global.ownerNomor = '6289505054287'
global.ownerName = 'Creator Rajadev'
global.ownerNumber = ["6289505054287@s.whatsapp.net"]
